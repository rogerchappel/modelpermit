...
Replace this section with the supported versions for `modelpermit`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `modelpermit` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in modelpermit.
